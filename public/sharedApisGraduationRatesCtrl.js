                    ...
                    $http(mashapeNumberFacts2017).then(function(response4) {
                        new Morris.Area({
                            ...
                            data: [{ year: "1942", a: parseInt(response2.data.text.length), b: 0 },
                                {
                                    year: "2016",
                                    a: parseInt(response3.data.text.length),
                                ...
                                {
                                    year: "2017",
                                    a: parseInt(response4.data.text.length),
                        ...
                        .then(function(response3) {
                            anychart.onDocumentReady(function() {
                                ...
                                var data = [
                                    ...
                                    {
                                        name: 'Media de aprobados en Private S por cada millon de habitantes',
                                        value: parseInt(response1.data
                                    ...
                                    {
                                        name: 'Media de aprobados en Public S por cada millon de habitantes',
                                        value: parseInt(response1.data
                    ...
                    var data = google.visualization.arrayToDataTable([
                        ...
                        [2014, parseInt(response1.data.Data.filter(d => d.Anyo == 2014)
                            .map(function(d) { return (parseFloat(d.Valor)) }).reduce(function(previous, current) {
                                return previous + current;
                            }) * 100 / response1.data.Data.filter(d => d.Anyo == 2014).length)],
                        ...
                        [2015, parseInt(response1.data.Data.filter(d => d.Anyo == 2015)
                            .map(function(d) { return (parseFloat(d.Valor)) }).reduce(function(previous, current) {
                                return previous + current;
                            }) * 100 / response1.data.Data.filter(d => d.Anyo == 2015).length)],
                        ...
                        [2016, parseInt(response1.data.Data.filter(d => d.Anyo == 2016)
                            .map(function(d) { return (parseFloat(d.Valor)) }).reduce(function(previous, current) {
                                return previous + current;
                            }) * 100 / response1.data.Data.filter(d => d.Anyo == 2016).length)],
                        ...
                        [2017, parseInt(response1.data.Data.filter(d => d.Anyo == 2017)
                            .map(function(d) { return (parseFloat(d.Valor)) }).reduce(function(previous, current) {
                                return previous + current;
                            }) * 100 / response1.data.Data.filter(d => d.Anyo == 2017).length)],
