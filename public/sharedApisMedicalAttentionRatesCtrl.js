                                                                            ...
                                                                            */
                                                                                ...
                                                                                Highcharts.chart('sharedStadistics3', {
                                                                                    ...
                                                                                    series: [{
                                                                                        ...
                                                                                        name: 'Latitude',
                                                                                        data: [response1.data.filter(d => d.province === 'sevilla' && d.year===2016 ).map(function(d) { return d["general-medicine"] })[0], 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8]
                                                                                    }]
                                                                                });
                                                                            });
                                                                    });
